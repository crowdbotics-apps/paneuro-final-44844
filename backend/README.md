...
## Project Structure
    ...
    ├── paneuropeanholdings_44844  # Django project configurations
...
1. Clone this repo and `cd paneuropeanholdings_44844`
...
2. Clone this repo and `cd paneuropeanholdings_44844`
